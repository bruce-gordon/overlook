...
## Success Areas
- Strong use of test driven development in the creation of object classes.
- Well organized methods for dom manipulation.
- Successful use of fetch requests to get, post, and delete data from an api.
- Applied aria properties, tab index, and color contrast for accessibility.
- Employed media queries for responsive design.
- Used hover states and design to create a more intuitive UX.
