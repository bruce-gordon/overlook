...
describe('BookingRepo', () => {
  ...
  it('should store all of the hotel bookings', () => {
    expect(bookingRepo.allBookings).to.deep.equal([
      {"id": "5fwrgu4i7k55hl6sz", "userID": 1, "date": "2020/04/22", "roomNumber": 2, "roomServiceCharges": []},
      {"id": "5fwrgu4i7k55hl6t5", "userID": 4, "date": "2020/01/24", "roomNumber": 9, "roomServiceCharges": []},
